...
use saltwater_core::*;
use saltwater_core::{ast::ExternalDeclaration, hir::Scope, lex::Keyword};
...
pub(crate) mod test {
    use super::Parser;
    use saltwater_core::ast::ExternalDeclaration;
    use saltwater_core::lex::test::cpp;
    use saltwater_core::*;
    ...
    fn test_strings() {
        let assert_str = |s, expected: &str| {
            use saltwater_core::ast::ExprType;
