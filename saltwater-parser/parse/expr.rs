...
use super::*;
use saltwater_core::ast::{Expr, ExprType, TypeName};
use saltwater_core::lex::{AssignmentToken, Keyword};
use saltwater_core::*;
...
impl TryFrom<&Token> for BinaryPrecedence {
    ...
    fn try_from(t: &Token) -> Result<BinaryPrecedence, ()> {
        use saltwater_core::lex::ComparisonToken as Compare;
...
pub(crate) mod test {
    ...
    use saltwater_core::ast::{Expr, ExprType};
