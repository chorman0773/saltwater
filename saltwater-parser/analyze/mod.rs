...
use saltwater_core::{error::Warning, hir::*, lex::Keyword, *};
use saltwater_core::intern::InternedStr;
...
impl PureAnalyzer {
    ...
    */
    ...
    fn parse_declarator(
        ...
        use saltwater_core::types::{ArrayType, FunctionType};
...
pub(crate) mod test {
    use super::{Error, *};
    use saltwater_core::types::{ArrayType, FunctionType, Type::*};
